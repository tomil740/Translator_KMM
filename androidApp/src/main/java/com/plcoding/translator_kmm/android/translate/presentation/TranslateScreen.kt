            ...
            item {
                ...
                item{
                    ...
                    TranslateTextField(
                        ...
                        onTranslateClick={onEvent.invoke(TranslateEvent.Translate)},
                    onTextChange={onEvent.invoke(TranslateEvent.ChangeTranslationText(it))},
                        onCopyClick = { text ->
                    ...
                    onCloseClick={onEvent.invoke(TranslateEvent.CloseTranslation)},
                    onSpeakerClick={
                        val language = state.toLanguage.toLocale() ?: Locale.ENGLISH
                        tts.speak(
                            state.toText,
                    ...
                    onTextFieldClick={onEvent.invoke(TranslateEvent.EditTranslation)},
                    modifier = Modifier
                    )
                }
            item {
