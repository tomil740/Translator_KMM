...
import com.plcoding.translator_kmm.core.domain.core.Resource
...
class TranslateViewModel(
    ...
    private val historyFlow = MutableStateFlow((listOf (HistoryItem(5.5.toLong(),
        Language.CHINESE.langCode,"s",Language.CHINESE.langCode,"f"))))
...
init {
    viewModelScope.launch {
        ...
        historyDataSource.getHistory().collectLatest { thenew->
            historyFlow.update {
                thenew
            }
        }
